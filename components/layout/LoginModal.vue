        ...
        <template v-slot:modal-body>
            ...
            <div class="social-login">
                ...
                <div class="btns d-flex flex-row justify-center w-100">
                    ...
                    <div class="btn twitter" v-if="settings.socialAuth && settings.socialAuth.twitter" @click="redirectSocial('twitter')"><i class="bi bi-twitter"></i> Twitter</div>
                    <div class="btn discord" v-if="settings.socialAuth && settings.socialAuth.discord" @click="redirectSocial('discord')"><i class="bi bi-discord"></i> Discord</div>
                </div>
            </div>
        </template>
    </CommonModal>
