...
<div class="dropdown-menu">
    ...
    <div class="user-info">
        <CommonAvatar src="https://i.imgur.com/45vM6qK.jpg" 
...
.user-info {
    ...
    align-items: center;
    padding: 15px;
    background-image: linear-gradient(to right, #654EA3, #B06AB3);
...
ul > li {
    ...
    border-width: 3px;
    border-style: solid;
    border-image: linear-gradient(to bottom, rgba(0, 0, 0, 0), rgba(0, 0, 0, 0)) 1 100%;
    border-right: 0;
    font-size: 14px;
...
ul > li:hover {
    border-width: 3px;
    border-style: solid;
    border-image: linear-gradient(to bottom, #654EA3, #B06AB3) 1 100%;
    border-right: 0;
    cursor: pointer;
}
