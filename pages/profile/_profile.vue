    ...
    <div id="profile">
        <div class="container">
            <div class="profile-header">
                ...
                <CommonAvatar :src="userAvatar(profile.details)" borderRadius="100px" height="130px" width="130px" :pointer=false />
            </div>
                    ...
                    <div class="tab-body">
                        ...
                        <div class="tab-content" v-else-if="activeTab === 'wall-posts'">
                            <div class="new-post d-flex flex-row" v-if="isAuthenticated">
                                <CommonAvatar :src="userAvatar(user.details)" borderRadius="5px" height="70px" width="70px" :pointer=false />
